							...
							<td style="border: 0; margin: 0; padding: 0;">
								<table width="570" border="0" cellspacing="0" cellpadding="0">
									<tbody>
										...
										<tr>
											<td style="border: 0; margin: 0; padding: 0;" align="left" valign="top">
												<table width="570" border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
														<td width="570"  align="center" valign="middle" style="border: 0; margin: 0; padding: 0; font-family:{{ $fontDefinitions }}; color:#1d5c58; font-size:24px; line-height:30px; font-weight:bold; word-spacing:-0.2px;">{!! $title !!}</td>
													</tr>
													<tr>
										...
										<tr>
											<td style="border: 0; margin: 0; padding: 0;">
												<table width="570" height="781" border="0" cellpadding="0" cellspacing="0" style="background: url('https://soup-journal-app-storage.s3.amazonaws.com/aloeaquabomb/playlist/playlist_vintage.jpg') no-repeat center bottom #1d5c58;">
													<tr>
														<td align="center" valign="top" width="570" height="281" style="border: 0; margin: 0; padding: 0; font-family: {{ $fontDefinitions }}; color:#ffffff; font-size:12px;">
															...
															<div style="width: 100%;padding-top:40px;"><a href="https://open.spotify.com/playlist/0lITqzk9EcDE83MStCgqXT?si=er_Nz5bkSDO_jImKs8Sk3w" target="_blank" style="text-decoration: none; color:#1d5c58; background-color: #ffffff; padding: 10px; font-weight: bold;">Follow your Playlist on Spotify</a></div>
														</td>
													</tr>
													<tr>
													...
													<table border="0" cellspacing="0" cellpadding="0" width="570">
														...
														<tr>
															...
															<td bgcolor="#1d5c58" style="border:0; margin:0; padding:10px 5px; text-align:center; font-family:{{ $fontDefinitions }}; color:#ffffff; font-size:14px; line-height:20px; font-weight:bold;">
																<a href="https://www.sephora.com/product/belif-the-true-cream-aqua-bomb-aloe-vera-P457514" target="_blank" style="white-space: nowrap; text-decoration: none; color:#ffffff;">Available at Sephora NOW!</a>
															</td>
															<td>
																<table border="0" cellspacing="0" cellpadding="0">
																	<tbody>

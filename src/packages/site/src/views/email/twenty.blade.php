				...
				<tr>
					<td style="border: 0; margin: 0; padding: 0;">
						<table width="570" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td style="border: 0; margin: 0; padding: 0;">
									<table width="570" height="781" border="0" cellpadding="0" cellspacing="0" style="background: url('https://soup-journal-app-storage.s3.amazonaws.com/aloeaquabomb/playlist/playlist_twenty.jpg') no-repeat center bottom #1d5c58;">
										<tr>
											<td align="center" valign="top" width="570" height="281" style="border: 0; margin: 0; padding: 0; font-family: {{ $fontDefinitions }}; color:#ffffff; font-size:12px;">
												...
												<div style="width: 100%;padding-top:40px;"><a href="https://open.spotify.com/playlist/3f27kyi7XRE525ZVpjxYhZ?si=Bm2oMs0gSay6TejfwAZU0g" target="_blank" style="text-decoration: none; color:#1d5c58; background-color: #ffffff; padding: 10px; font-weight: bold;">Follow your Playlist on Spotify</a></div>
											</td>
										</tr>
										<tr>

					...
					<tbody>
								...
								<div>
									<table width="570" border="0" cellspacing="0" cellpadding="0" >
										<tbody>
											...
											<tr>
												<td align="center" valign="middle" style="border: 0; margin: 0; padding: 0; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color:#0072bc; text-transform:uppercase; font-size:31px; line-height:56px; font-weight:bold; letter-spacing:-0.4px;">Your sample is on its way!</td>
											</tr>
											<tr>
												<td align="center" valign="middle" style="border: 0; margin: 0; padding: 0; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color:#00aeef; font-size:21px; line-height:48px; font-weight:bold; letter-spacing:-0.8px;">You should receive it within 7-10 days</td>
											</tr>
											<tr>
						...
						<tr>
							<td style="border: 0; margin: 0; padding: 0; font-size: 0; line-height:0;" height="21"></td>
										...
										<tr>
											<td style="border: 0; margin: 0; padding: 0; text-align:center; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size:14px; line-height: 20px; font-style:italic;"><a href="{{ $unsubscribeLink }}" style="text-decoration:none; color:#000000;">

<?php
	...
	class AppGlobals {
		...
		//forgot password
		const EMAIL_PASSWORD_RESET_SENDER = ['name' => 'Soup', 'email' => "team@soupjournal.com"]; //"test@belifinhydration.com"; 
		...
		const EMAIL_MEMBER_REQUEST_SENDER = ['name' => 'Soup', 'email' => "team@soupjournal.com"]; //"test@belifinhydration.com"; 

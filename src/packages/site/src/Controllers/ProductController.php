	...
	class ProductController extends BaseController {
		...
		public function getQuestion() {
			...
			if ($questionData) {
				...
				return View::make('belif::pages.question')->with(Array (
					...
					'backURL' => $questionIndex>1 ? route('belif.question.previous') : route('belif.home'),
		...
		public function getResults() {
			...
			return View::make('belif::pages.results')->with(Array (
				...
				'textColor' => ($sampleResult == self::FORM_RESULTS_A) ? 'color-4' : 'color-3'
			));

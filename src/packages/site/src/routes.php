...
Route::group(array('namespace' => 'Belif\Mobile\Controllers', 'middleware' => ['web']), function() {

	// sephora dedicated landing page
	Route::get('/sephora', ['as' => 'belif.sephora', 'uses' => 'MainController@getSephora']);

			...
			Route::group(array('middleware' => 'AppHTTPS'), function() {
				...
				Route::group(array('middleware' => ['AppAuth']), function() {
					...
					Route::group(array('middleware' => 'AppReview'), function() {
						...
						Route::get('/venue/profile/{safestr}', ['as' => 'soup.venue.profile', 'uses' => 'MainController@getVenueProfile']);
						
						//reservation
						Route::get('/reservation/{safestr}', ['as' => 'soup.reservation.id', 'uses' => 'MainController@getReservation']);
						Route::get('/reservation/{safestr}/{safestr2}', ['as' => 'soup.reservation.id.id', 'uses' => 'MainController@getReservation']);
